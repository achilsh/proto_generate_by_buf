...
type DemoServiceClient interface {
	Echo(ctx context.Context, in *DemoRequestBody, opts ...grpc.CallOption) (*DemoResponseBody, error)
}
...
func (c *demoServiceClient) Echo(ctx context.Context, in *DemoRequestBody, opts ...grpc.CallOption) (*DemoResponseBody, error) {
	out := new(DemoResponseBody)
	err := c.cc.Invoke(ctx, "/protoc.demo.demoService/Echo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DemoServiceServer interface {
	Echo(context.Context, *DemoRequestBody) (*DemoResponseBody, error)
...
func (UnimplementedDemoServiceServer) Echo(context.Context, *DemoRequestBody) (*DemoResponseBody, error) {
...
func _DemoService_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protoc.demo.demoService/Echo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServiceServer).Echo(ctx, req.(*DemoRequestBody))
	}
...
var DemoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protoc.demo.demoService",
